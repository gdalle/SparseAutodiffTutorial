...
# ╔═╡ 7aaca1d4-fa94-11ef-05bc-27d17dc64153
begin
...
# ╔═╡ ca6d463b-9247-45e2-af2b-ca337e99b49b
md"""
# Sparse automatic differentiation
"""

# ╔═╡ 876af08b-683b-4e14-a98a-99a669ca8309
md"""
## Pattern detection
"""

# ╔═╡ 8428d1cb-74b0-449a-bffb-38428636516f
sparsity_detector = TracerSparsityDetector()

# ╔═╡ dffdfea5-177e-4b65-885c-7d43a60b9eb4
function f_test(x::AbstractVector)
	return [x[1], x[2] * sum(x[3:7])]
end

# ╔═╡ 42313df4-9935-4ccd-b3bc-782720bceb3e
x_test = ones(10);

# ╔═╡ 722450e9-2791-4c1d-a420-66f5a220e732
jacobian_sparsity(f_test, x_test, sparsity_detector)

# ╔═╡ cb9f6783-c181-4f69-ad6a-aea58382a7ea
md"""
## Coloring
"""

# ╔═╡ 13486571-0b32-40a1-bb41-062d72e6a9cf
coloring_problem = ColoringProblem(; structure=:nonsymmetric, partition=:row)

# ╔═╡ 2ab58122-88ba-4b7a-ade6-7bfe0052064b
order = RandomOrder(StableRNG(0), 0)

# ╔═╡ cb189c0b-ac91-4f35-8cec-06ead42797a6
coloring_algorithm = GreedyColoringAlgorithm(order; postprocessing=true)

# ╔═╡ 1f2d10cf-880d-46e2-8003-9e5d37f0dd97
A = sprand(StableRNG(63), 20, 10, 0.1)

# ╔═╡ f8286b5e-47a5-41a8-9cf1-192a57aa5d3b
result = coloring(A, coloring_problem, coloring_algorithm)

# ╔═╡ 6398a9d9-42e1-4ca5-b68b-caf84ee0f893
B = compress(A, result)

# ╔═╡ 6142db5c-a9ac-4664-950e-9d35e49c7e02
decompress(B, result)

# ╔═╡ 8abd3f73-cb9f-4738-bdb0-6e3f668b99d2
A_color, B_color = SparseMatrixColorings.show_colors(
	result, 
...
# ╔═╡ 4b28c578-fccb-4517-9912-370d5225a928
A_color

# ╔═╡ e4c37184-6a3f-40c7-9237-b5aab95145c8
B_color

# ╔═╡ 2f3475d9-f891-441b-bff9-1a56a9140b58
md"""
## Full pipeline
"""

# ╔═╡ 975d3eaa-a010-4b31-9f6e-aeb23e542f4e
backend = AutoSparse(
	AutoForwardDiff();
	coloring_algorithm,
	sparsity_detector
...
# ╔═╡ 740bd81e-11c8-4740-ae17-efc4ffed5c38
f(x) = 2x

# ╔═╡ 02a4a22c-7ed7-47b9-b25c-3aeb32cb17bf
x = rand(StableRNG(63), 10);

# ╔═╡ 53d9e8d3-a406-4cde-87bb-22a367fede69
prep = prepare_jacobian(f, backend, x)

# ╔═╡ e7a6546d-e02f-4f5a-a6f6-e4acf31bc2c3
...
ADTypes = "~1.14.0"
ColorSchemes = "~3.29.0"
DifferentiationInterface = "~0.7.1"
ForwardDiff = "~1.0.1"
Images = "~0.26.2"
...
manifest_format = "2.0"
project_hash = "7c03512168961a7bd4600a7b406901eabddcd697"
